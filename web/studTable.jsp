...
<head>
    ...
    <script>
            function personal(i)
            {
                ...
                var f=document.form;      
                     f.method="post";
                     f.action='stud_personal_display.jsp?i='+i;
                     f.submit();
            }
             function edu(i)
            {
                ...
                var f=document.form;      
                     f.method="post";
                     f.action='stud_edu_display.jsp?i='+i;
                     f.submit();
            }
            function up(i)
            {
    ...
    <div class="wrapper">
    <div class="sidebar" data-color="blue" data-image="assets8/img/sidebar-4.jpg">
    ...
    -->
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a class="nav-link" href="http://localhost:8080/finalProject/teacherTable.jsp">
                            <i class="nc-icon nc-notes"></i>
                            <p>Teacher Information</p>
                        </a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="http://localhost:8080/finalProject/studTable.jsp">
             ...
             <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid  ">
                    <a class="navbar-brand" href="#pablo">
                        <i class="nc-icon nc-single-02"></i> Student Information </a>
...
ResultSet rs=st.executeQuery("select * from s_userpass");
%>
 <%
        while(rs.next())
        {
        ...
        <tr>
            ...
            <td><input type="submit" value="personal" onclick="personal(<%=rs.getInt(1)%>)"</td>
            <td><input type="submit" value="edu" onclick="edu(<%=rs.getInt(1)%>)"</td>
